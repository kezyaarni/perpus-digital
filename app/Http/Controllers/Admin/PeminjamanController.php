...
class PeminjamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.peminjaman.index')->with('Succsess', 'Transaksi peminjaman berhasil dicatat.');
    }
    ...
    public function updateStatus(Peminjaman $peminjaman)
    {
        if($peminjaman->status === 'dipinjam'){
            ...
            return redirect()->route('admin.peminjaman.index')->with('sucsess','buku telah dikembalikan.' );
        }
    }
